...
\begin{itemize}
  ...
  \item \textbf{Micro-inertia and energy flux:} at $\bar{k}=200$, the bounded phase-speed result differs from its asymptote by $2.85\times10^{-4}$; the group-velocity/energy-flux identity has residual $6.91\times10^{-10}$.
\end{itemize}
