...
\end{equation}
connecting the group velocity $\bm{v}_g = \nabla_{\bmk}\omega$ directly to the volumetric energy flux and total stored energy. This identity is checked numerically; the group-velocity/energy-flux residual is $6.91\times10^{-10}$ (Table~\ref{tab:consistency_suite}).
