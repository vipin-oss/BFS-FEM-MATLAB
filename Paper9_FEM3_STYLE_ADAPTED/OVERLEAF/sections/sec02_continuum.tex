...
\end{equation}
The operator $1-\ell_{\mathrm{i}}^2\nabla^2$ increases the effective inertia of spatially varying acceleration. For the shear branch examined here, Section~\ref{sec:microinertia} and \ref{app:asymptotics} show that this term bounds the high-wavenumber phase speed.
...
\begin{enumerate}[label=(\roman*)]
  ...
  \item \textbf{Gradient elasticity without micro-inertia ($\ell_{\mathrm{i}} = 0$):} Higher-order stiffness remains while dynamic regularization is removed; the transverse branch analyzed in \ref{app:asymptotics} then has $v_p\propto k$ as $k\to\infty$.
