...
The two-dimensional periodic medium is formed by translating the square cell $\Omega_{\mathrm{cell}}=[0,L]\times[0,L]$ along
\begin{equation}
...
\end{equation}
Because the conforming $C^1$ space contains derivative degrees of freedom, differentiating this relation gives
\begin{equation}
...
For Case~H, length, frequency, and velocity are scaled using the cell length $L$, shear modulus $\mu$, and density $\rho$:
\begin{equation}
