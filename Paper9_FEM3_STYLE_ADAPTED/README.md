...
- `OVERLEAF/manuscript.pdf` is refreshed by the branch's GitHub Actions TeX build after the final source changes are pushed. The page-by-page visual checklist is `MANUSCRIPT_FINAL_PDF_CHECKLIST.md`.
