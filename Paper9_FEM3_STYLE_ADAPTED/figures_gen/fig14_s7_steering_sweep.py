...
def main():
    ...
    ax1.set_xticks(ths)
    grid(ax1)
    legend(ax1, loc="lower left", fontsize=8, framealpha=0.7, outside=True, outside_center=0.25)
    ...
    ax1b.set_ylim(-5, 95)
    legend(ax1b, loc="lower right", fontsize=8, framealpha=0.7, outside=True, outside_center=0.75)
    ...
    grid(ax2)
    legend(ax2, loc="lower right", fontsize=8, framealpha=0.7, outside=True, outside_center=0.50)
