# B1 — Author-Data Receipt Template (Layer 1 — classical limit, Li et al. 2024 Fig. 2(a))
...
| Field | Value |
|---|---|
| Benchmark | B1 (Layer 1 — classical limit, Li et al. 2024 Fig. 2(a)) |
| Source article | Li, Li, Guo, Wang & Wang, *Scientific Reports* **14**:24035 (2024), DOI 10.1038/s41598-024-75049-1 |
| Published item the data correspond to | Fig. 2(a) (l = 0, l₁ = 0, f = 0, L = 0, L₁ = 0; AlN/BaTiO₃ bilayer, normal incidence) |
...
| Field | Value |
|---|---|
| Acceptance threshold applied | **≤ 2 %** mandatory; **≤ 0.5 %** classical-limit target applies to this benchmark |
