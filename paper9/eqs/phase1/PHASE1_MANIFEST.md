...
- **F1** five-constant presentation vs factorized (26) modulus; legacy FEM_3 (84)–(85) is not
  the isotropic limit of (26) — needs a decision before any `a1..a5` comparison is quoted.
- **F2** symmetric-pair factor conventions (explicit `K_g` form for M14).
- **M5-a** free micro-inertia boundary term → consistency check in M15.
