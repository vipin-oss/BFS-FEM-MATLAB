...
\input{../tables/out/tab01_literature_positioning.tex}
\end{table}
...
\begin{enumerate}[label=\textbf{C\arabic*.}]
  ...
  \item \textbf{Quantification of directional band gaps and wave steering:} We map directional stop bands over the $(\theta, \mathrm{AR})$ design space, quantify orientation sensitivity $S_\theta$, and demonstrate acoustic wave-vector steering deviations $\delta(\phi)$ up to $2.78^\circ$.
\end{enumerate}
