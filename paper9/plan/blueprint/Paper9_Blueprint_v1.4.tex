...
\textbf{Version} & 1.4 --- LOCK; single amendment to \S5.7 (pre-declared numerical-resolution admissibility rule \emph{Rule R-fit} for the observed convergence rate) and the PCR5 wording. v1.4 is derived from v1.3 (sha256 \texttt{ca71b91aba4ca4abe9f157eb595ac8c2f709d838957a08ea0dce7160685dbf9f}); all other content is unchanged --- the amendment is itemised in \texttt{paper9/audit/P12H\_A1\_PROTOCOL\_CLOSURE\_AUDIT.md}; P12J (2026-09-24) clarification: the \S5.7 rule now states its declared numerical zero explicitly, $e_i > F \cdot \max(s_i, 10^{-15})$ with $F = 3$, decided inactive for every recorded result (\texttt{paper9/audit/P12J\_CORRECTION\_CLOSURE\_AUDIT.md}) \\
