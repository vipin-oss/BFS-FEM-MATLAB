...
and this item fails; a graphical result must never be reported or described as quantitative.
...
\midrule
Graph only, parameters ambiguous or insufficient & \textbf{Not validated}: no claim; the G3/PCR1 item
fails for that benchmark \\
\bottomrule
\end{tabularx}
\end{center}
