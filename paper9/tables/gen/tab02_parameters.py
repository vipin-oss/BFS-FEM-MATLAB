...
def main():
    ...
    content = "\n".join(lines) + "\n"
    # P12AH layout: give the long \texttt identifiers (e.g. volume_equivalent,
    # (p11d_b2_gap_registry.json) a zero-width break opportunity after each escaped
    # underscore so they can wrap instead of overflowing the column.  No character of
    # content is added or removed - the rendered glyphs are identical.
