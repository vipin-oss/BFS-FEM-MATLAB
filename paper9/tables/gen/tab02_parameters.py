...
def main():
    ...
    lines = [
        ...
        "\\begin{tabularx}{\\textwidth}{@{}l >{\\raggedright\\arraybackslash}p{2.5cm} >{\\raggedright\\arraybackslash}p{1.8cm} c L{3.0cm} Y@{}}",
        "\\toprule",
    ...
    content = "\n".join(lines) + "\n"
    # Layout only: give the long \texttt identifiers (volume_equivalent,
    # p11d_b2_gap_registry.json, CALC_MASTER_PLAN) a zero-width break opportunity after each
    # escaped underscore so they wrap inside their column instead of running off the page.
    # No character of content is added or removed - the rendered glyphs are identical.
