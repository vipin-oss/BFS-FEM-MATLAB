...
def main():
    ...
    rec["benchmarks"]["B3"] = dict(
        ...
        reason=("source parameters are available (cbar1 = 0.15, dbar1 = 0.25, cR = dR = 1.5, "
                ...
                "omega_bar ~= 0.35 at k_bar = 1 whereas the source's own gradient ('Present', solid) "
                "curve lies at ~0.436 there (P12T measurement, consistent with the digitised reading "
                "(1, ~0.45) recorded above); the classical limit is 0.500 and the dashed literature [34] "
                "curve is ~0.50; the available dipolar-gradient transfer-matrix "
